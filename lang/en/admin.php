...
$string['pathtopdftoppm_help'] = 'On most Linux installs, this can be left as \'/usr/bin/pdftoppm\'. If not present, install the xpdf package. On Windows it will be provided by Cygwin installs. See <a href="https://poppler.freedesktop.org/" target="_blank">Poppler project</a> for more details.';
